...
<head>
    ...
    <title>Money Me - Dashboard</title>
...
<body>
    <div class="header">
        <img src="img/money.png" width="25px" height="25px" class="float-left logo-fav">
        <h3 class="text-secondary font-weight-bold float-left logo">Money</h3>
        <h3 class="text-secondary float-left logo2">- Me</h3>
        <a href="logout">
            <div class="logout">
                ...
                <div class="container" id="container" style="border: none;">
                    <div class="row tampilCardview" id="row">
                        ...
                        <div class="col-md-4 jarak">
                            <div class="card card-stats card-warning" style="background: #808080;">
                                <div class="card-body ">
                                    <div class="row">
                                        <div class="col-5">
                        ...
                        <div class="col-md-4 jarak">
                            <a href="tambahPengeluaran" style="text-decoration: none;">
                                ...
                                <div class="overlay" style="background: #00008b;">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="icon-big text-center">
