...
<body id="page-top">
    ...
    <header id="home" class="text-light parallax">
        <div class="container konten">
            <h1 style="font-size: 36pt;">Welcome to Keuangan</h1>
    ...
    <section id="features" class="bg-light">
        <div class=" container konten2">
            ...
            <div class="col-lg-12 foot-fitur">
                <h4 class="headline text-center">Keuangan</h4>
                <p class="isi-fitur text-center">Keuangan adalah aplikasi web pencatatan keuangan harian yang
